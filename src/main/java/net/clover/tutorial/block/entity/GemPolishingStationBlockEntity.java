package net.clover.tutorial.block.entity;

import net.clover.tutorial.TutorialMod;
import net.clover.tutorial.item.ModItems;
import net.clover.tutorial.recipe.GemPolishingRecipe;
import net.clover.tutorial.screen.GemPolishingScreenHandler;
...
public class GemPolishingStationBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory, ImplementedInventory {
    ...
    public Text getDisplayName() {
        return Text.translatable("block."+ TutorialMod.MOD_ID + ".gem_polishing_station.display_name");
    }
    ...
    private void craftItem() {
        //Hardcoded. Duplicate below fixes, but currently has an issue in the GemPolishingRecipe.java class
    ...
    private boolean hasRecipie() {
        //Currently hardcoded. Will fix later in tutorial hopefully
        ItemStack result = new ItemStack(ModItems.RUBY);
